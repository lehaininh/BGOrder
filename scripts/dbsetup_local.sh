...
if [ $IS_DB_CREATED -ne 1 ]; then
    echo "universe database was not created"
    echo "Creating universe database..."
    ...
    echo "Granting access for DbUser to SeanoteDb";
...
DIR_NAME=$(pwd)
SOURCE_PATH_DDL_CONST="$DIR_NAME/scripts/ddl/const/*"
SOURCE_PATH_DDL_DATA="$DIR_NAME/scripts/ddl/data/*"
SOURCE_PATH_DML_CONST="$DIR_NAME/scripts/dml/const/*"
SOURCE_PATH_DML_DATA="$DIR_NAME/scripts/dml/data/*"
